...
> Help me with your referral [Link](https://t.me/cvt_official_bot/main?startapp=6713068747)
...
```json
{
  ...
  "doTasks": true,
  "playGames": true,
  "referralCode": "6713068747" // Do not change it if you want to support me ^^
}
```
